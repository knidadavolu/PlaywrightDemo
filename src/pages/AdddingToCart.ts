...
export class AddingToCart {
  ...
  constructor(page: Page) {
    ...
    this.addToCart_productPrice = page.locator(
  ...
  async selectQuality(qualityNumber: string) {
    await this.addToCart_quality.waitFor({ state: "visible" });
